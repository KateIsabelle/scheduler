...
//test getAppointmentsForDay helper function
...
//test getInterview helper function
...
//test getInterviewersForDay helper function
test("getInterviewersForDay returns an array", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(Array.isArray(result)).toBe(true);
});

test("getInterviewersForDay returns an array with the length matching the number of interviewers for that day", () => {
  const result = getInterviewersForDay(state, "Monday");
...
test("getInterviewersForDay returns an empty array when the daysdata is empty", () => {
